...
exports.manualTripleDesDecrypt = manualTripleDesDecrypt;
// S-Boxes
const SBOX = [
    // sbox1
...
function initial_permutation(input_data) {
    let s0 = bitnum(input_data, 57, 31) | bitnum(input_data, 49, 30) | bitnum(input_data, 41, 29) | bitnum(input_data, 33, 28) |
    ...
    let s1 = bitnum(input_data, 56, 31) | bitnum(input_data, 48, 30) | bitnum(input_data, 40, 29) | bitnum(input_data, 32, 28) |
...
function crypt_block(input_data, key) {
...
function tripledes_crypt(data, keys) {
    for (let i = 0; i < 3; i++) {
        data = crypt_block(data, keys[i]);
    }
    return data;
}
function manualTripleDesDecrypt(input, key) {

...
exports.fetchQQWithDecrypt = fetchQQWithDecrypt;
const zlib_1 = __importDefault(require("zlib"));
const QQMusicCrypto_1 = require("../utils/QQMusicCrypto");
const QRC_KEY = Buffer.from("!@#)(*$%123ZXC!@!@#)(NHL");
async function fetchQQWithDecrypt(relativePath, queryParams) {
...
function decryptQrc(hexString) {
    if (!hexString)
        return null;
    try {
        const encryptedBytes = Buffer.from(hexString, 'hex');
        const decryptedBytes = (0, QQMusicCrypto_1.manualTripleDesDecrypt)(encryptedBytes, QRC_KEY);
        // Zlib Decompress
        const result = zlib_1.default.inflateSync(decryptedBytes);
